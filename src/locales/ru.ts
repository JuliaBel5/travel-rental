export const ru = {
  ...
  auth: {
    ...
    login: {
      title: "Вход",
      subtitle: "Войдите, чтобы бронировать жильё.",
      email: "Эл. почта",
      password: "Пароль",
      submit: "Войти",
      submitting: "Входим…",
      error: "Неверная почта или пароль.",
      tooMany: "Слишком много попыток входа. Попробуйте позже.",
      noAccount: "Нет аккаунта?",
      signUpLink: "Зарегистрироваться",
    },
    signup: {
      title: "Регистрация",
      subtitle: "Создайте аккаунт, чтобы бронировать.",
      name: "Имя",
      email: "Эл. почта",
      password: "Пароль",
  ...
  account: {
    ...
    profile: {
      title: "Профиль",
      description: "Ваше имя и фото, которые видят другие.",
      displayName: "Отображаемое имя",
      displayNamePlaceholder: "Ваше имя",
      nameTooShort: "Введите имя (минимум 2 символа)",
      nameTooLong: "Имя слишком длинное (максимум 80 символов)",
      save: "Сохранить",
      saving: "Сохраняем…",
    ...
    avatar: {
      ...
      hint: "PNG, JPG или WebP. Лучше всего смотрится квадратное фото.",
    },
    info: {
      title: "Данные аккаунта",
      description: "Основная информация вашего аккаунта.",
      email: "Эл. почта",
    ...
    danger: {
      ...
      confirm: "Точно удалить аккаунт?",
      confirmHint: "Это действие необратимо.",
